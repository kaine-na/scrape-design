 ...
 *
 * IMPORTANT: The script body is stored as an array of lines joined with
 * explicit "\n" at runtime. This prevents bundlers (esbuild, webpack, etc.)
 * from transforming, minifying, or rewriting the template literal contents.
 *
 * Browserless /function expects ES module format:
 * `export default async ({ page, context }) => { ... return {...}; }`
 *
